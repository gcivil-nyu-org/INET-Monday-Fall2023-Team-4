...
class CustomUserTest(TestCase):
	def setUp(self):
		CustomUser.objects.create(username='test',email='test@email.com',first_name='test1first',last_name='test1last')
		CustomUser.objects.create(username='test2',email='test@nyu.edu',first_name='test2first',last_name='test2last')
